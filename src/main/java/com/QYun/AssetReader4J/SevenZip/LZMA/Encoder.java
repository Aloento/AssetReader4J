package com.QYun.AssetReader4J.SevenZip.LZMA;

import com.QYun.AssetReader4J.SevenZip.ICodeProgress;
import com.QYun.AssetReader4J.SevenZip.RangeCoder.BitTreeEncoder;
...
public class Encoder {
    ...
    com.QYun.AssetReader4J.SevenZip.LZ.BinTree _matchFinder = null;

    ;
    com.QYun.AssetReader4J.SevenZip.RangeCoder.Encoder _rangeEncoder = new com.QYun.AssetReader4J.SevenZip.RangeCoder.Encoder();
    ...
    void Create() {
        if (_matchFinder == null) {
            com.QYun.AssetReader4J.SevenZip.LZ.BinTree bt = new com.QYun.AssetReader4J.SevenZip.LZ.BinTree();
            int numHashBytes = 4;
    ...
    void Init() {
        ...
        com.QYun.AssetReader4J.SevenZip.RangeCoder.Encoder.InitBitModels(_isMatch);
        com.QYun.AssetReader4J.SevenZip.RangeCoder.Encoder.InitBitModels(_isRep0Long);
        com.QYun.AssetReader4J.SevenZip.RangeCoder.Encoder.InitBitModels(_isRep);
        com.QYun.AssetReader4J.SevenZip.RangeCoder.Encoder.InitBitModels(_isRepG0);
        com.QYun.AssetReader4J.SevenZip.RangeCoder.Encoder.InitBitModels(_isRepG1);
        com.QYun.AssetReader4J.SevenZip.RangeCoder.Encoder.InitBitModels(_isRepG2);
        com.QYun.AssetReader4J.SevenZip.RangeCoder.Encoder.InitBitModels(_posEncoders);
    ...
    int GetRepLen1Price(int state, int posState) {
        return com.QYun.AssetReader4J.SevenZip.RangeCoder.Encoder.GetPrice0(_isRepG0[state]) +
                com.QYun.AssetReader4J.SevenZip.RangeCoder.Encoder.GetPrice0(_isRep0Long[(state << Base.kNumPosStatesBitsMax) + posState]);
    }

    int GetPureRepPrice(int repIndex, int state, int posState) {
        int price;
        if (repIndex == 0) {
            price = com.QYun.AssetReader4J.SevenZip.RangeCoder.Encoder.GetPrice0(_isRepG0[state]);
            price += com.QYun.AssetReader4J.SevenZip.RangeCoder.Encoder.GetPrice1(_isRep0Long[(state << Base.kNumPosStatesBitsMax) + posState]);
        } else {
            price = com.QYun.AssetReader4J.SevenZip.RangeCoder.Encoder.GetPrice1(_isRepG0[state]);
            if (repIndex == 1)
                price += com.QYun.AssetReader4J.SevenZip.RangeCoder.Encoder.GetPrice0(_isRepG1[state]);
            else {
                price += com.QYun.AssetReader4J.SevenZip.RangeCoder.Encoder.GetPrice1(_isRepG1[state]);
                price += com.QYun.AssetReader4J.SevenZip.RangeCoder.Encoder.GetPrice(_isRepG2[state], repIndex - 2);
            }
        }
        return price;
    }
    ...
    int GetOptimum(int position) throws IOException {
        ...
        _optimum[1].Price = com.QYun.AssetReader4J.SevenZip.RangeCoder.Encoder.GetPrice0(_isMatch[(_state << Base.kNumPosStatesBitsMax) + posState]) +
                _literalEncoder.GetSubCoder(position, _previousByte).GetPrice(!Base.StateIsCharState(_state), matchByte, currentByte);
        _optimum[1].MakeAsChar();

        int matchPrice = com.QYun.AssetReader4J.SevenZip.RangeCoder.Encoder.GetPrice1(_isMatch[(_state << Base.kNumPosStatesBitsMax) + posState]);
        int repMatchPrice = matchPrice + com.QYun.AssetReader4J.SevenZip.RangeCoder.Encoder.GetPrice1(_isRep[_state]);
        ...
        int normalMatchPrice = matchPrice + com.QYun.AssetReader4J.SevenZip.RangeCoder.Encoder.GetPrice0(_isRep[_state]);
        ...
        while (true) {
            ...
            int curAnd1Price = curPrice +
                    com.QYun.AssetReader4J.SevenZip.RangeCoder.Encoder.GetPrice0(_isMatch[(state << Base.kNumPosStatesBitsMax) + posState]) +
            ...
            matchPrice = curPrice + com.QYun.AssetReader4J.SevenZip.RangeCoder.Encoder.GetPrice1(_isMatch[(state << Base.kNumPosStatesBitsMax) + posState]);
            repMatchPrice = matchPrice + com.QYun.AssetReader4J.SevenZip.RangeCoder.Encoder.GetPrice1(_isRep[state]);
            ...
            if (!nextIsChar && matchByte != currentByte) {
                ...
                if (lenTest2 >= 2) {
                    ...
                    int nextRepMatchPrice = curAnd1Price +
                            com.QYun.AssetReader4J.SevenZip.RangeCoder.Encoder.GetPrice1(_isMatch[(state2 << Base.kNumPosStatesBitsMax) + posStateNext]) +
                            com.QYun.AssetReader4J.SevenZip.RangeCoder.Encoder.GetPrice1(_isRep[state2]);
                    {
                    ...
                    if (lenTest2 >= 2) {
                        ...
                        int curAndLenCharPrice =
                                repMatchPrice + GetRepPrice(repIndex, lenTest, state, posState) +
                                        com.QYun.AssetReader4J.SevenZip.RangeCoder.Encoder.GetPrice0(_isMatch[(state2 << Base.kNumPosStatesBitsMax) + posStateNext]) +
                        ...
                        int nextMatchPrice = curAndLenCharPrice + com.QYun.AssetReader4J.SevenZip.RangeCoder.Encoder.GetPrice1(_isMatch[(state2 << Base.kNumPosStatesBitsMax) + posStateNext]);
                        int nextRepMatchPrice = nextMatchPrice + com.QYun.AssetReader4J.SevenZip.RangeCoder.Encoder.GetPrice1(_isRep[state2]);
            ...
            if (newLen >= startLen) {
                normalMatchPrice = matchPrice + com.QYun.AssetReader4J.SevenZip.RangeCoder.Encoder.GetPrice0(_isRep[state]);
    ...
    void FillDistancesPrices() {
        ...
        for (int lenToPosState = 0; lenToPosState < Base.kNumLenToPosStates; lenToPosState++) {
            ...
            for (posSlot = Base.kEndPosModelIndex; posSlot < _distTableSize; posSlot++)
                _posSlotPrices[st + posSlot] += ((((posSlot >> 1) - 1) - Base.kNumAlignBits) << com.QYun.AssetReader4J.SevenZip.RangeCoder.Encoder.kNumBitPriceShiftBits);
    ...
    class LiteralEncoder {
        ...
        class Encoder2 {
            ...
            public void Init() {
                com.QYun.AssetReader4J.SevenZip.RangeCoder.Encoder.InitBitModels(m_Encoders);
            }


            public void Encode(com.QYun.AssetReader4J.SevenZip.RangeCoder.Encoder rangeEncoder, byte symbol) throws IOException {
                int context = 1;
                for (int i = 7; i >= 0; i--) {
                    int bit = ((symbol >> i) & 1);
            ...
            public void EncodeMatched(com.QYun.AssetReader4J.SevenZip.RangeCoder.Encoder rangeEncoder, byte matchByte, byte symbol) throws IOException {
                int context = 1;
                boolean same = true;
                for (int i = 7; i >= 0; i--) {
                    int bit = ((symbol >> i) & 1);
            ...
            public int GetPrice(boolean matchMode, byte matchByte, byte symbol) {
                ...
                if (matchMode) {
                    for (; i >= 0; i--) {
                        int matchBit = (matchByte >> i) & 1;
                        int bit = (symbol >> i) & 1;
                        price += com.QYun.AssetReader4J.SevenZip.RangeCoder.Encoder.GetPrice(m_Encoders[((1 + matchBit) << 8) + context], bit);
                        context = (context << 1) | bit;
                        if (matchBit != bit) {
                            i--;
                            break;
                ...
                for (; i >= 0; i--) {
                    int bit = (symbol >> i) & 1;
                    price += com.QYun.AssetReader4J.SevenZip.RangeCoder.Encoder.GetPrice(m_Encoders[context], bit);
                    context = (context << 1) | bit;
                }
                return price;
            }
    ...
    class LenEncoder {
        ...
        public void Init(int numPosStates) {
            com.QYun.AssetReader4J.SevenZip.RangeCoder.Encoder.InitBitModels(_choice);
        ...
        public void Encode(com.QYun.AssetReader4J.SevenZip.RangeCoder.Encoder rangeEncoder, int symbol, int posState) throws IOException {
        ...
        public void SetPrices(int posState, int numSymbols, int[] prices, int st) {
            int a0 = com.QYun.AssetReader4J.SevenZip.RangeCoder.Encoder.GetPrice0(_choice[0]);
            int a1 = com.QYun.AssetReader4J.SevenZip.RangeCoder.Encoder.GetPrice1(_choice[0]);
            int b0 = a1 + com.QYun.AssetReader4J.SevenZip.RangeCoder.Encoder.GetPrice0(_choice[1]);
            int b1 = a1 + com.QYun.AssetReader4J.SevenZip.RangeCoder.Encoder.GetPrice1(_choice[1]);
            int i = 0;
